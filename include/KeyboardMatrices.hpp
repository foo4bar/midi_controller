...
namespace kbd
{
    ...
    inline KeyboardMatrixIO<numberOfOutputPairsLeft, numberOfInputs> keyboardMatrixIOLeft{KeyboardMatrixIO<numberOfOutputPairsLeft, numberOfInputs>::Builder<numberOfOutputPairsLeft, numberOfInputs>{}
                                                                                              ...
                                                                                              .build()};
    inline KeyboardMatrixIO<numberOfOutputPairsRight, numberOfInputs> keyboardMatrixIORight{KeyboardMatrixIO<numberOfOutputPairsRight, numberOfInputs>::Builder<numberOfOutputPairsRight, numberOfInputs>{}
