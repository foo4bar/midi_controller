...
inline const kbd::ContactMatrix contactMatrixLeft = kbd::ContactMatrix::Builder<number_of_key_groups_left>{}
                                                        ...
                                                        .build();
inline const kbd::ContactMatrix contactMatrixRight = kbd::ContactMatrix::Builder<number_of_key_groups_right>{}
                                                         .withFirstClosedContactsOutputs({28, 24, 2, 6, 5})
                                                         .withLastClosedContactsOutputs({30, 26, 22, 4, 7})
                                                         .withInputs({35, 33, 31, 29, 27, 25, 23, 3})
                                                         .build();
inline const kbd::KeyboardController keyboardController{{contactMatrixLeft, contactMatrixRight}, first_key_note_number};
