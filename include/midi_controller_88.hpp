...
inline const kbd::ContactMatrix keyboardMatrixLeft = kbd::ContactMatrix::Builder<number_of_key_groups_left>{}
                                                         ...
                                                         .build();
inline const kbd::ContactMatrix keyboardMatrixRight = kbd::ContactMatrix::Builder<number_of_key_groups_right>{}
