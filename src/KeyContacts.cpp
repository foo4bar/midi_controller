...
namespace kbd
{
    ...
    void KeyContacts::updateStateWithDebouncing(KeyboardMatricesIO &keyboardMatrices)
    {
        const auto inputStatePair{keyboardMatrices.getActualInstantaneousKeyInputStates(this->number)};
